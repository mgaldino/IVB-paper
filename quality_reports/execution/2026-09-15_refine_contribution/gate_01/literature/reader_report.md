...
Suponha que o pesquisador compare $B=(D,W,L)$ e $C=(D,W,Z)$. O coeficiente de $D$ quase não muda entre $B$ e $C$, mas o percurso $B\rightarrow U\rightarrow C$ contém dois movimentos grandes e de sinais opostos: adicionar $Z$ a $B$ mantendo $L$ ($B\rightarrow U$) move o coeficiente para baixo; retirar $L$ de $U$ mantendo $Z$ ($U\rightarrow C$) move o coeficiente para cima. Equivalentemente, as duas inclusões aninhadas, $B\rightarrow U$ e $C\rightarrow U$, movem o coeficiente para baixo e entram subtraídas na identidade para $\widehat\beta_C-\widehat\beta_B$. A diferença líquida pequena entre $B$ e $C$ mascara esses canais.
