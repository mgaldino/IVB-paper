...
The applications serve two purposes. First, they show that the decomposition yields empirical specification-shift diagnostics rather than only theoretical algebra. Second, they show why those shifts require separate timing and causal judgments. Across the `r cc_summary$n_candidates` theory-selected candidate controls in these six studies, the median $|\mathrm{IVB}/\mathrm{SE}|$ is `r sprintf('%.2f', cc_summary$median_ivb_se)`, and `r cc_summary$n_over_one` case exceeds one standard error. These are descriptive results from a purposive set of applications, not estimates of the prevalence or magnitude of causal bias in TSCS research.
