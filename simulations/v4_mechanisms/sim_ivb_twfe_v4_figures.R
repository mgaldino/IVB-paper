...
# Load results
res_A <- fread("results/sim_ivb_twfe_v4_mechA.csv")
res_B <- fread("results/sim_ivb_twfe_v4_mechB.csv")
res_C <- fread("results/sim_ivb_twfe_v4_mechC.csv")
res_D <- fread("results/sim_ivb_twfe_v4_mechD.csv")
...
fwrite(synthesis_summary, "results/sim_ivb_twfe_v4_synthesis.csv")
cat("Saved: results/sim_ivb_twfe_v4_synthesis.csv\n")
