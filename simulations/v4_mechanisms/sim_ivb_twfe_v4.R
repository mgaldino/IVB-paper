...
fwrite(results_A, "results/sim_ivb_twfe_v4_mechA.csv")
fwrite(results_B, "results/sim_ivb_twfe_v4_mechB.csv")
fwrite(results_C, "results/sim_ivb_twfe_v4_mechC.csv")
fwrite(results_D, "results/sim_ivb_twfe_v4_mechD.csv")
...
# Record session info
writeLines(capture.output(sessionInfo()), "results/sim_ivb_twfe_v4_sessioninfo.txt")
