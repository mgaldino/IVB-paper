...
#
# IMPORTANT: This script assumes the working directory is simulations/v1_twfe/
# (two levels below the project root IVB-paper/). All ggsave() calls use
# relative paths under "../../plots/" to write to the project-root plots folder.
# =============================================================================
