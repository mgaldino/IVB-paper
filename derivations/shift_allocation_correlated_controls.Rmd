...
sequential_error <- max(abs(order_sums - joint_shift))
...
validation_table <- data.frame(
  check = c(
    ...
    "Sequential paths telescope to the joint shift",
    "Shapley allocation is invariant to a permutation of control names",
  ...
  criterion = c(
    ...
    "difference > 1e-4", "difference > 1e-4"
  ),
...
validation_table$result <- ifelse(
  c(
    ...
    validation_table$metric[5L] > 1e-4
  ),
  "PASS",
  "FAIL"
)
