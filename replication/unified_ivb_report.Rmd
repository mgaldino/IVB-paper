...
3. **Lagging is not a mechanical cure.** Blair et al.'s strategy of lagging controls one additional period beyond the treatment (3 vs. 2 years) rules out strict contemporaneous collider channels. However, as the lag-substitution result in the main paper shows, IVB persists whenever the treatment is autocorrelated across periods ($\pi_k = \sum_\ell \pi_\ell \omega_{\ell k} \neq 0$). The nonzero IVBs for Blair et al. illustrate that lag structures attenuate but do not guarantee elimination of bias.
...
cat(sprintf(paste0(
  "1. **No sign reversals.** In none of the four studies does removing the ",
  ...
  "applications.\n\n",
  "3. **Magnitude changes are modest but not negligible.** The largest proportional ",
  "IVB is Leipziger's GDP per capita for the public services outcome: the ",
  "published coefficient of $\\hat\\beta^* = %.4f$ would be $\\hat\\beta = %.4f$ ",
  "without the collider, a %.1f%% attenuation. This is meaningful for interpretation ",
  "--- the \"true\" effect of democracy on ethnic inequality may be roughly one-sixth ",
  "larger than published --- but it does not overturn the paper's central finding. ",
  "For Claassen, Albers et al., and Blair et al., the proportional IVBs from ",
  "literature-supported colliders are smaller (generally under 10%%).\n\n",
...
), conclusions$beta_long[3], conclusions$beta_short[3], lp_pct))
```
