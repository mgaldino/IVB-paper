...
# install.packages(c('xtable','texreg','plm','arm','dplyr','tidyr','ggplot2','RColorBrewer','rworldmap','rworldmap','statmod','AER','phtt','gtools','rgdal'))
...
# Get data
supdem = read.csv("Support_democracy_ajps_correct.csv")
