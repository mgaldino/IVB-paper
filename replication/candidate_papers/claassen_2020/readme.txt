Files included in replication materials for "Does Public Support Help Democracy Survive", AJPS, including erratum
----------------------------------------------------------------------------------------------------------------------------

Software


Analyses were carried out using R version 4.3.0 for Windows (x86_64-w64-mingw32/x64 (64-bit))


Data /  CSV files


Support_democracy_ajps_correct.csv  -  Corrected panel (country-year) data necessary to reproduce results in paper. Does not require re-estimating support and satisfaction.
...
supdem raw survey marginals correct.csv  -  Corrected raw survey marginals, for estimating smooth panel of support for democracy (necessary only for results in supplementary materials)
...
codebook support democracy ajps correct.pdf  -  Codebook for the dataset Support_democracy_ajps_correct.csv

codebook satisdem raw survey marginals.pdf  -  Codebook for the dataset satisdem raw survey marginals.csv

codebook supdem raw survey marginals.pdf  -  Codebook for the dataset supdem raw survey marginals correct.csv

codebook vdem15.pdf  -  Codebook for the dataset vdem15.csv


R code files


supdem democracy ajps replication correct.R  -  Corrected R code necessary to  reproduce results in paper and most results in supplementary materials
...
data merge ajps correct.R  -  Corrected R code to merge estimated support for and satisfaction with democracy with other country-year panel data (optional)
